...
describe Category do
  ...
  describe '#recent_videos' do
    ...
    it 'returns an array of all videos in the category if there are less than 6 with the most recently created first' do
    ...
    it 'returns an array of only the 6 most recent videos if there are more than 6 videos in the category' do
      the_matrix = Video.create(title: 'The Matrix', description: 'Woah...', category: @category)
      star_wars = Video.create(title: 'Star Wars', description: 'A long time ago in a galaxy far, far away...', category: @category)
